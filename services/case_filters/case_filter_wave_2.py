...
class CaseFilterWave2(CaseFilterBase):
    ...
    def case_is_eligible(self, case: BlaiseCaseInformationModel) -> bool:
        return (
                ...
                and self.case_has_a_desired_rotational_outcome_code_of(self.valid_rotational_outcome_codes, case)
                and self.case_is_in_a_known_region(case)
                and self.case_is_eligible_if_no_telephone_numbers_are_set(case)
        )

    def case_is_eligible_if_no_telephone_numbers_are_set(self, case: BlaiseCaseInformationModel) -> bool:
    ...
    def case_has_no_telephone_numbers_set(self, case: BlaiseCaseInformationModel) -> bool:
        return (
