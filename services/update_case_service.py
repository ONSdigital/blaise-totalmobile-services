...
def _update_case_contact_information(
    blaise_case, update_blaise_case_model, questionnaire_service: QuestionnaireService
) -> None:
    fields_to_update = {}
...
def validate_questionnaire_exists(
    questionnaire_name: str, questionnaire_service: QuestionnaireService
) -> None:
...
def get_case(
    questionnaire_name: str, case_id: str, questionnaire_service: QuestionnaireService
