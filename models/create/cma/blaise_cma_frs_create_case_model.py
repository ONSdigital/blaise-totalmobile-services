...
class FRSCaseModel:
    ...
    def format_data_fields(self) -> dict[str, Any]:
        return {
            ...
            "cmA_ContactData": f"PII.TLA\tFRS\tPII.Month\t{self.get_month()}\tPII.Year\t{self.get_year()}\tPII.Prem1\t{self.prem1}\tPII.Prem2\t{self.prem2}\tPII.Town\t{self.town}\tPII.Postcode\t{self.postcode}",
        }
