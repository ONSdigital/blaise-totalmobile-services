...
class TestLMSBlaiseUpdateCaseModel:
    ...
    def test_get_knock_to_nudge_indicator_flag_field_returns_expected_dictionary(self):
        # arrange
        questionnaire_name = "LMS2101_TLR"
    ...
    def test_get_outcome_code_fields_returns_an_expected_dictionary(self):
        # arrange
        questionnaire_name = "LMS2101_TLR"
        blaise_case = LMSBlaiseUpdateCase(questionnaire_name, {})
    ...
    def test_get_contact_details_fields_returns_an_expected_dictionary(self):
        # arrange
        questionnaire_name = "LMS2101_TLR"
        blaise_case = LMSBlaiseUpdateCase(questionnaire_name, {})
        totalmobile_request = TotalMobileIncomingUpdateRequestModel(
