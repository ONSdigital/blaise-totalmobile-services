...
def get_populated_case_model(
    ...
    wave: Optional[int] = 1,
    address_line_1: Optional[str] = "12 Blaise Street",
    address_line_2: Optional[str] = "Blaise Hill",
    address_line_3: Optional[str] = "Blaiseville",
    county: str = "Gwent",
    town: str = "Newport",
    postcode: str = "FML134D",
    telephone_number_1: Optional[str] = "07900990901",
    telephone_number_2: Optional[str] = "07900990902",
    appointment_telephone_number: str = "07900990903",
    outcome_code: int = 301,
    latitude: str = "10020202",
    longitude: str = "34949494",
    reference: Optional[str] = "100012675377",
    priority: str = "1",
    field_case: str = "Y",
