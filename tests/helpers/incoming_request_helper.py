def get_populated_update_case_request_for_contact_made(
    ...
    return {
        "result": {
            ...
            "form": {"reference": "LMS-Contact Made No Visit", "version": 10},
            "association": {
                "workType": "LMS",
                "reference": reference,
            ...
            "responses": [
                ...
                },
                {
                    ...
                    "responses": [
                        {
                            "value": contact_name,
                            "element": {"reference": "Contact_Name", "text": "Name:"},
                        },
                        {
                    ...
                    "element": {"reference": "LMS_CD", "text": "Contact Details"},
                },
            ],
...
def get_populated_update_case_refusal_request(
    ...
    return {
        "result": {
            ...
            "form": {"reference": "LMS-Refusal", "version": 36},
            "association": {
                "workType": "LMS",
                "reference": reference,
            ...
            "responses": [
                {
                    ...
                    "element": {"reference": "LMS_Refusal", "text": "Refusal"},
                },
                {
                    "instance": 0,
                    "responses": [
