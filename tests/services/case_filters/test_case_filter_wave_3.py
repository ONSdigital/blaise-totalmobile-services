...
@pytest.fixture()
def service() -> CaseFilterWave3:
    return CaseFilterWave3()


@pytest.fixture()
def valid_wave_3_case_without_telephone_numbers() -> BlaiseCaseInformationModel:
...
def test_case_is_eligible_returns_true_only_where_criteria_for_wave_2_without_telephone_is_met(
    ...
    valid_wave_3_case_without_telephone_numbers,
    service: CaseFilterWave3,
):
    # arrange
    case = valid_wave_3_case_without_telephone_numbers
    case.rotational_knock_to_nudge_indicator = knock_to_nudge_indicator

    # act
    result = service.case_is_eligible(valid_wave_3_case_without_telephone_numbers)
...
@pytest.mark.parametrize(
    "outcome_code, rotational_outcome_code", [(0, 0), (310, 0), (0, 310), (310, 310)]
)
