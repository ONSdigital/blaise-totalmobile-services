...
class TestFRSCreateTotalmobileJobsService:
    def test_check_questionnaire_release_date_logs_when_there_are_no_questionnaires_for_release(
            self,
            mock_questionnaire_service,
            service: CreateTotalmobileJobsService,
    ...
    def test_map_totalmobile_job_models_maps_the_correct_list_of_models(
        ...
        assert (
                ...
                == TotalMobileOutgoingCreateJobPayloadModel.import_case(
            questionnaire_name=questionnaire_name,
            questionnaire_case=case_data[0],
            uac_chunks=None
        ).to_payload()
        )
        assert result[0].payload["description"] == "UAC: \nDue Date: \nStudy: FRS2101\nCase ID: 10010\nWave: None"        # TODO: Confirm w/Martyn - what do you want?
        ...
        assert result[1].payload["description"] == "UAC: \nDue Date: \nStudy: FRS2101\nCase ID: 10020\nWave: None"
        ...
        assert result[2].payload["description"] == "UAC: \nDue Date: \nStudy: FRS2101\nCase ID: 10030\nWave: None"
