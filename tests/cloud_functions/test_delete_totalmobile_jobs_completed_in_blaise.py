...
from cloud_functions.delete_totalmobile_jobs_completed_in_blaise import delete_totalmobile_jobs_completed_in_blaise
...
def test_delete_totalmobile_jobs_completed_in_blaise_returns_done():
    ...
    # act and assert
    assert delete_totalmobile_jobs_completed_in_blaise(mock_delete_totalmobile_jobs_service) == "Done"
